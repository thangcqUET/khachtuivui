...
import { MessageCircle, Eye, EyeOff, ArrowLeft, Check } from "lucide-react"
...
export default function RegisterPage() {
  ...
  if (isAuthenticated) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-gray-800 mb-4">Bạn đã có tài khoản</h1>
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <Card className="shadow-lg border-0">
          <CardHeader>
            <CardTitle className="text-center text-xl text-gray-800">Tạo tài khoản mới</CardTitle>
          </CardHeader>
          <CardContent>
            <form action={action} className="space-y-4">
              ...
              <div>
                ...
                >
                  ...
                  <option value="fastfood">Quán ăn nhanh</option>
                  <option value="bar">Quán bar/pub</option>
              ...
              <div className="flex items-start">
                ...
                <label htmlFor="newsletter" className="ml-2 block text-sm text-gray-700">
                  Nhận thông tin khuyến mãi và cập nhật sản phẩm qua email
                </label>
              </div>
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-gray-600">
                Đã có tài khoản?{" "}
                <Link href="/dang-nhap" className="text-blue-600 hover:text-blue-700 font-medium">
                  Đăng nhập ngay
                </Link>
              </p>
            </div>
        ...
        <div className="mt-8 bg-white/50 rounded-lg p-4">
          <h3 className="text-sm font-semibold text-gray-800 mb-3">Lợi ích khi đăng ký:</h3>
          <ul className="space-y-2 text-sm text-gray-600">
            ...
            <li className="flex items-center">
              <Check className="h-4 w-4 text-green-500 mr-2 flex-shrink-0" />
              Setup và hỗ trợ kỹ thuật miễn phí
            </li>
            <li className="flex items-center">
              <Check className="h-4 w-4 text-green-500 mr-2 flex-shrink-0" />
              Đào tạo sử dụng cho nhân viên
            </li>
            <li className="flex items-center">
              <Check className="h-4 w-4 text-green-500 mr-2 flex-shrink-0" />
              Hỗ trợ 24/7 trong thời gian dùng thử
            </li>
          </ul>
        </div>
      </div>
